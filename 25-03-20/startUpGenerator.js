...
// Write a javascript program that randomly generates a startup idea for you. 
// Each time you run it, you should see a random combination from the two 
// arrays below for a great startup idea, e.g. "Skynet for Pandas"
...
console.log(randomFromArray(thisArray).concat(' for ', randomFromArray(thatArray)));



// function randomFromArray (arrayName1, arrayName2) {
//     return (arrayName1[Math.floor(Math.random() * arrayName1.length)] + " for " + arrayName2[Math.floor(Math.random() * arrayName2.length)]); 
// }

// console.log(randomFromArray(thisArray, thatArray));